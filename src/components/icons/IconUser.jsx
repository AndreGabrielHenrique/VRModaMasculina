...
// Componente React para o ícone de usuário/perfil
// Representa a conta do usuário e menu de perfil

import React from 'react'

// Componente funcional IconUser
// Parâmetros:
// - size: tamanho do ícone (padrão 24px)
// - ariaLabel: texto para acessibilidade (padrão 'Usuário')
export default function IconUser({ size = 24, ariaLabel = 'Usuário' }) {
  return (
    <svg 
      viewBox="0 0 24 24" 
      fill="currentColor" 
    ...
    >
      {/* Primeiro caminho: cabeça/rosto do ícone de usuário (círculo com detalhes) */}
      ...
      {/* Segundo caminho: corpo/silhueta do ícone de usuário */}
